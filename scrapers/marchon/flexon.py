...
def get_flexon_data(latitude, longitude):
    # Define the base URL
...
def main():
    ...
    output_file = '../../data/marchon/flexon_store_locations.csv'
    ...
    for coord in coordinates:
        try:
            ...
            data = get_flexon_data(latitude, longitude)
