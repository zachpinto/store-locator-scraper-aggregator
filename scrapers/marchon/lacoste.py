...
def get_lacoste_data(latitude, longitude):
    # Define the base URL
    ...
    <request>
      ...
      <formdata id="locatorsearch">
        ...
        <limit>40</limit>
        <where>
          <la><eq>1</eq></la> <!-- Lacoste selected -->
        </where>
      </formdata>
    </request>
    """
...
def main():
    ...
    output_file = '../../data/marchon/lacoste_store_locations.csv'
    ...
    for coord in coordinates:
        try:
            ...
            data = get_lacoste_data(latitude, longitude)
