...
def get_pure_data(latitude, longitude):
    # Define the base URL
    ...
    <request>
      ...
      <formdata id="locatorsearch">
        ...
        <limit>40</limit>
        <where>
          <pure><eq>1</eq></pure> <!-- Pure selected -->
        </where>
      </formdata>
    </request>
    """
...
def main():
    ...
    output_file = '../../data/marchon/pure_store_locations.csv'
    ...
    for coord in coordinates:
        try:
            ...
            data = get_pure_data(latitude, longitude)
