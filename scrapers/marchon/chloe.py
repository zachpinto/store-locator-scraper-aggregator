...
def get_chloe_data(latitude, longitude):
    # Define the base URL
...
def main():
    ...
    output_file = '../../data/marchon/chloe_store_locations.csv'
    ...
    for coord in coordinates:
        try:
            ...
            data = get_chloe_data(latitude, longitude)
