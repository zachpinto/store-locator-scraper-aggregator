...
def get_cutlerandgross_data(latitude, longitude):
    # Define the base URL
    ...
    <request>
      ...
      <formdata id="locatorsearch">
        ...
        <limit>40</limit>
        <where>
          <cutlerandgross><eq>1</eq></cutlerandgross> <!-- Cutler and Gross selected -->
        </where>
      </formdata>
    </request>
    """
...
def main():
    ...
    output_file = '../../data/marchon/cutler_and_gross.csv'
    ...
    for coord in coordinates:
        try:
            ...
            data = get_cutlerandgross_data(latitude, longitude)
