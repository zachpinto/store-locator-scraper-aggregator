...
def get_dkny_data(latitude, longitude):
    # Define the base URL
    ...
    <request>
      ...
      <formdata id="locatorsearch">
        ...
        <limit>40</limit>
        <where>
          <dkny><eq>1</eq></dkny> <!-- DKNY selected -->
        </where>
      </formdata>
    </request>
    """
...
def main():
    ...
    output_file = '../../data/marchon/dkny_store_locations.csv'
    ...
    for coord in coordinates:
        try:
            ...
            data = get_dkny_data(latitude, longitude)
